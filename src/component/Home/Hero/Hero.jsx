...
import LongMenu from '../../common/LongMenu.jsx';
import { homeBanner } from '../../../data/Data.jsx'
import IconMenu from '../../common/IconMenu.jsx';
...
const Hero = () => {
    return (
        <>
            <div className='overlay top-[200px] relative container ml-auto mr-auto '>
                <div className="grid h-full grid-cols-[20%_50%_30%] gap-4 ">
                    <div className="relative ">
                        <IconMenu></IconMenu>
                    </div>
                    <div className="bg-green-200 overflow-hidden">
                        <Carousel data={homeBanner.largeBanner}></Carousel>
                    </div>
                    <div className=" grid  grid-rows-2 gap-3.5 rounded overflow-hidden">
                        {homeBanner.smallBanner.map((val) => (
