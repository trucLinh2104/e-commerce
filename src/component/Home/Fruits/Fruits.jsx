        ...
        <div className='mt-40 container ml-auto mr-auto'>
            <div className='flex flex-col mb-10 mx-4 md:mx-20 lg:flex lg:justify-between lg:flex-row lg:mx-10 lg:gap-10'>
                ...
                <ul className='flex flex-row flex-wrap'>
                    <li className='py-2 px-3 border rounded-full text-white w-32 text-center mx-2 my-2 lg:mx-1 hover:cursor-pointer' style={{backgroundColor: 'rgb(255, 252, 189)'}}>All Products</li>
                    ...
                    return (
                        <div key={val.id} className='box border rounded-lg border-orange-400 mx-auto mb-6 w-full'>
                            <div className='w-full relative overflow-clip'>
                                ...
                                <span className='absolute top-3 left-3 text-white text-lg py-1 px-4 rounded-xl' style={{backgroundColor: 'rgb(255, 252, 189)'}}>Fruits</span>
                            </div>
