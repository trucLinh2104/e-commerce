        ...
        <div className='mt-40 mx-4 md:grid md:grid-cols-2 md:mx-24 grid gap-4 sm:grid sm:mx-20 lg:grid-cols-3 lg:mx-24 xl:mx-40'>
            <div className='box-service border-2 border-orange-400 rounded-xl relative'>
                <div className='relative max-w-full z-10'>
                    <img src="src/assets/img/featur-1.jpg" className='w-full rounded-t-xl'  alt="" />
                    <div className='info-service relative bottom-20 py-8 px-12 w-9/12 sm:w-7/12 md:w-9/12  max-w-full rounded-lg text-center' style={{backgroundColor: '#0B8457'}}>
                ...
                <div className='w-full h-64 absolute bottom-0 rounded-xl'style={{backgroundColor: 'rgb(255, 252, 189)'}}></div>
            </div>
            <div className='box-service border-2 border-orange-400 rounded-xl relative'>
                <div className='relative max-w-full z-10'>
                    <img src="../../../assets/img/featur-2.jpg" className='w-full rounded-t-xl'  alt="" />
                    <div className='info-service relative bottom-20 py-8 px-12 w-9/12 sm:w-7/12 md:w-9/12  max-w-full rounded-lg text-center' style={{backgroundColor: '#f4f6f8 '}}>
                        <h4 className='text-white text-xl font-semibold' style={{color: '#0B8457'}}>Tasty Fruits</h4>
            ...
            <div className='box-service border-2 border-orange-400 rounded-xl relative'>
                <div className='relative max-w-full z-10'>
                    <img src="../../../assets/img/featur-3.jpg" className='w-full rounded-t-xl '  alt="" />
                    <div className='info-service relative bottom-20 py-8 px-12 w-9/12 sm:w-7/12 md:w-9/12 md:px-6 max-w-full rounded-lg text-center' style={{backgroundColor: 'rgb(255, 252, 189)'}}>
                ...
                <div className='w-full h-64 absolute bottom-0 rounded-xl' style={{backgroundColor: '#0B8457'}}></div>
            </div>
        </div>
    )
}
